...
export default function FeedPageContent({ title, hashtag }: FeedPageContentProps) {
  const { posts, loading, error, onCreate, onComment, onEdit, onDelete, onToggleLike, onToggleRetweet, clearError } =
    usePosts({ hashtag });
